...
**Attributes**:
- **Primary**: `amenity`
- **Detail**: `name`, `ref`, `alt_name`, `short_name`, `official_name`, `wikidata`, `wikipedia`, `access`, `air_conditioning`, `atm`, `bicycle_parking`, `bicycle_rental`, `booth`, `branch`, `brand`, `capacity`, `capacity:disabled`, `changing_table`, `community_centre`, `covered`, `cuisine`, `denomination`, `diet:gluten_free`, `diet:halal`, `diet:kosher`, `diet:vegan`, `diet:vegetarian`, `dispensing`, `drive_through`, `fair_trade`, `fee`, `female`, `fountain`, `gender_segregated`, `indoor`, `indoor_seating`, `internet_access`, `layer`, `level`, `location`, `male`, `organic`, `outdoor_seating`, `parking`, `parking_space`, `private`, `recycling:cans`, `recycling:clothes`, `recycling:glass`, `recycling:glass_bottles`, `recycling:paper`, `recycling:plastic`, `recycling:plastic_bottles`, `recycling:plastic_packaging`, `recycling_type`, `religion`, `reservation`, `self_service`, `smoking`, `social_facility`, `social_facility:for`, `surface`, `takeaway`, `toilets`, `toilets:disposal`, `townhall:type`, `unisex`, `vending`, `waste`, `wheelchair`
